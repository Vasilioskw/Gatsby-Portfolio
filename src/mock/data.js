...
export const aboutData = {
  ...
  paragraphOne: 'Born in New York, I moved to Houston, Texas to focus on myself and expand opportunities in my field of work. Currently, I do real estate management with a small team that oversees 50+ properties in over 12 states. Working on a commission basis, I\'ve constantly had to innovate myself in a field no-one ever trained me for. Seeing the limitations of marketing, and just how out-dated the real estate industry has become, I\'ve turned to learning full-stack software engineering / development with DigitalCrafts. I\'m hoping to build a social, real estate, data-base matching application that will revolutionize the industry. With first-hand experience in issues the real estate industry is facing, I have already completed a down-scaled project version that utilizes SQL (Sequelize ORM), Postgres, JavaScript, HTML, NPM packages (such as: express & es6 template engine). To build towards a full-scale version, I\'m working on the addition of PG Promise functionality, Redux, and React ( React is awesome and scale-able!).',
  paragraphTwo: 'I\'m also improving my upderstanding of Ruby & the Ruby on Rails Framework - Which is the first language I learned, via the Flatiron School Prep-Course. My area of understanding includes HTML, CSS (+ Animations), CLI, JavaScript, jQuery, Promises, Axios, AJAX, Node 101, Express (+Express Template Engine & Middleware), Ruby (+ Ruby on Rails), PostgreSQL, React JS, Redux, Data Modeling, pg-Promise, Sequelize ORM, & state management.',
