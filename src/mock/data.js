...
export const heroData = {
  ...
  subtitle: 'I\'m a Real Estate Sales Agent / Broker and Proptech Startup Founder',
  cta: '',
};
...
export const aboutData = {
  ...
  paragraphOne: 'Living between New York & Texas - I manage 50+ properties across the sunbelt for an individuals\' real estate portfolio. Seeing just how outdated real estate marketing has become, I earned a certificate in "Full-Stack Web Development" with DigitalCrafts to improve the field and change how real estate is marketed.',
...
export const projectsData = [
  ...
  },
  {
    ...
    info2: 'In ambitions to create the real estate application of my dreams, I\'ve created downscaled versions in different languages and frameworks to learn more about the best foundation. I\'m hoping these projects serve as a launching pad to a more advanced product that can be commercialized.',
  ...
  },
  {
    ...
    url: '',
    repo: 'https://github.com/Vasilioskw/the-property-finder-app', // if no repo, the button will not show up
  },
  {
    id: nanoid(),
    img: 'dev-arcade.png',
